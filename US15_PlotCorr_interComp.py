...
ax1.set_xlabel('fc Lead Time (Days)',fontsize=5)
ax1.set_xlim(-1,13)
...
plt.title('Correlation: SEKF vs SEKF Initialized Forecast',fontsize=7)
l1 = ax1.plot(lai,linewidth=0.5,marker='.',markersize=4,label='LAI')[0]
l2 = ax1.plot(rzsm,linewidth=0.5,marker='.',markersize=4,label='RZSM')[0]
l3 = ax1.plot(wg2,linewidth=0.5,marker='.',markersize=4,label='WG2')[0]
#l4 = ax1.plot(wg3,linewidth=0,marker='.',markersize=4,label='WG3')[0]
l5 = ax1.plot(runoff,linewidth=0.5,marker='.',markersize=4,label='RUNOFF')[0]
l6 = ax1.plot(drain,linewidth=0.5,marker='.',markersize=4,label='DRAIN')[0]
l7 = ax1.plot(evap,linewidth=0.5,marker='.',markersize=4,label='EVAP')[0]
...
### EVAP
#ax1.set_ylim(0.70,0.75)
plt.title('RMSD Change : SEKF vs SEKF Initialized Forecast',fontsize=7)
l1 = ax1.plot(le,linewidth=0.5,marker='.',markersize=4,label='LAI')[0]
l2 = ax1.plot(re,linewidth=0.5,marker='.',markersize=4,label='RZSM')[0]
l3 = ax1.plot(we,linewidth=0.5,marker='.',markersize=4,label='WG2')[0]
#l4 = ax1.plot(wg3e,linewidth=0,marker='.',markersize=4,label='WG3')[0]
l5 = ax1.plot(rue,linewidth=0.5,marker='.',markersize=4,label='RUNOFF')[0]
l6 = ax1.plot(de,linewidth=0.5,marker='.',markersize=4,label='DRAIN')[0]
l7 = ax1.plot(ee,linewidth=0.5,marker='.',markersize=4,label='EVAP')[0]
