...
if ana == "EVAP":
    ...
    #plt.legend(handles+handles2,labels+labels2,numpoints=1,fontsize=6,bbox_to_anchor=(0.985,0.92))
    ...
    ax1.set_yticks(np.arange(0.35,0.66,step=0.15))
    ...
    indplot()
    plt.title('ISBA Forecast LAI vs CGLS LAI - 99% CI',fontsize=7)
    ### R
    ...
    #handles, labels = ax1.get_legend_handles_labels()
    #handles2, labels2 = ax2.get_legend_handles_labels()
    #ax1.legend(handles+handles2,labels+labels2,numpoints=1,fontsize=6,bbox_to_anchor=(0.985,0.92))
    ...
    axes[0].set_ylim(0.30,0.70)
    axes[0].set_yticks(np.arange(0.35,0.66,step=0.15))
    plt.yticks(np.arange(0.50,0.75,step=0.1))
    l1 = axes[0].plot(x,R_ssm_ol15,color='b',marker='.',linewidth=1,label='R fc_init_ol',transform=trans,markeredgecolor='black',markersize=6)[0]
    l2 = axes[0].plot(x,R_ssm_ekf15,color='r',marker='.',linewidth=1,label='R fc_init_ekf',transform=trans2,markeredgecolor='black',markersize=6)[0]
    ax1.set_ylabel('RMSD[$m^3$/$m^3$]')
    ax1.set_ylim(0.0375,0.062)
    ax1.set_yticks(np.arange(0.040,0.061,step=0.01))
    l5 = ax1.plot(x,RMSD_ssm_ol15,color='b',marker='s',linewidth=1,label='RMSD fc_init_ol',transform=trans_,markeredgecolor='black',markersize=4,linestyle='--')[0]
    l6 = ax1.plot(x,RMSD_ssm_ekf15,color='r',marker='s',linewidth=1,label='RMSD fc_init_ekf',transform=trans2_,markeredgecolor='black',markersize=4,linestyle='--')[0]
    #axes[0].set_xticks(np.arange(14),ticks)
    ...
    axes[1].set_yticks(np.arange(0.50,0.75,step=0.1))
    m1 = axes[1].plot(x,R_lai_ol15,color='b',marker='.',linewidth=1,label='R fc_init_ol',transform=trans_2,markeredgecolor='black',markersize=6)[0]
    m2 = axes[1].plot(x,R_lai_ekf15,color='r',marker='.',linewidth=1,label='R fc_init_ekf',transform=trans2_2,markeredgecolor='black',markersize=6)[0]
    ax2.set_ylabel('RMSD[$m^2$/$m^2$]')
    ax2.set_ylim(0.55,1.10)
    ax2.set_yticks(np.arange(0.6,1.11,step=0.2))
    m5 = ax2.plot(x,RMSD_lai_ol15,color='b',marker='s',linewidth=1,label='RMSD fc_init_ol',transform=trans__,markeredgecolor='black',markersize=4,linestyle='--')[0]
    m6 = ax2.plot(x,RMSD_lai_ekf15,color='r',marker='s',linewidth=1,label='RMSD fc_init_ekf',transform=trans2__,markeredgecolor='black',markersize=4,linestyle='--')[0]
    #axes[1].set_xticks(np.arange(14),ticks)
    ...
    axes[2].set_ylim(0.53,0.6)
    axes[2].set_yticks(np.arange(0.54,0.61,step=0.02))
    n1 = axes[2].plot(x,R_et_ol15,color='b',marker='.',linewidth=1,label='R fc_init_ol',transform=trans_3,markeredgecolor='black',markersize=6)[0]
    n2 = axes[2].plot(x,R_et_ekf15,color='r',marker='.',linewidth=1,label='R fc_init_ekf',transform=trans2_3,markeredgecolor='black',markersize=6)[0]
    ax3.set_ylabel('RMSD[mm/day]')
    ax3.set_ylim(1.34,1.43)
    ax3.set_yticks(np.arange(1.34,1.43,step=0.04))
    n5 = ax3.plot(x,RMSD_et_ol15,color='b',marker='s',linewidth=1,label='RMSD fc_init_ol',transform=trans___,markeredgecolor='black',markersize=4,linestyle='--')[0]
    n6 = ax3.plot(x,RMSD_et_ekf15,color='r',marker='s',linewidth=1,label='RMSD fc_init_ekf',transform=trans2___,markeredgecolor='black',markersize=4,linestyle='--')[0]
    axes[2].set_xlim(0.5,14.5)
    axes[2].set_xlabel('fc Lead Time (Days)')
    #axes[2].set_xticks(np.arange(14),ticks)
