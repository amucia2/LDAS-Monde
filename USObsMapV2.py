...
isba = lai_isba.mean(axis=0).values.reshape((140,280))
...
axes[0].set_title("CGLS LAI",fontsize=16)
...
axes[1].set_title("VOD LAI",fontsize=16)
...
map.drawmeridians(np.arange(-120,-60,10),labels=[0,0,0,1],linewidth=.5)
map.drawparallels(np.arange(25,55,5),labels=[1,0,0,0],linewidth=.5)
cs2 = map.imshow(vod,interpolation='none',cmap='RdYlGn',vmin=0,vmax=4)
