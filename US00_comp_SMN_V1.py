...
#fc0 = ('0','1','2','3','4','5')
##wg = ('WG3','WG3','WG3','WG3','WG3','WG3')
##wg = ('WG6','WG6','WG6','WG6','WG6','WG6')
##wg = ('WG8','WG8','WG8','WG8','WG8','WG8')
#wg = ('WG_20','WG_20','WG_20','WG_20','WG_20','WG_20')
##dep = ('0.05','0.05','0.05','0.05','0.05','0.05')
##dep = ('0.50','0.50','0.50','0.50','0.50','0.50')
##dep = ('1.00','1.00','1.00','1.00','1.00','1.00')
#dep = ('0.20','0.20','0.20','0.20','0.20','0.20')
...
### WG_20 - 20cm Correlation
#wg3_1D = pd.read_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/{0}/results/{1}{2}/{3}_2017_2018.PData'.format(exp,ens_1,fc,wg))
#wg3_ekf_1D = pd.read_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/{0}/results/{1}{2}/{3}_2017_2018.PData'.format(exp,ens_2,fc,wg))
...
for coord in range(len(lat)):
    ...
    if (lat_1D[-1,0] >= lat[coord] >= lat_1D[0,0]) and (lon_1D[0,-1] >= lon[coord] >= lon_1D[0,0]):
        ...
        if (len(obs_05bis.resample('D').mean()[~np.isnan(obs_05bis.resample('D').mean())]) > 100):
            ...
            #dst2 = list()
            #for y_lat in range(len(lat_1D2[:,0])):
                #for y_lon in range(len(lon_1D2[0,:])):
                    #dst2.append(haversine(lon[coord],lat[coord],lon_1D2[0,:][y_lon],lat_1D2[:,0][y_lat],y_lon,y_lat))
            #dst2 = np.array(dst2)

            print(dst[[np.argsort(dst[:,0])[0]],0],\
                    lat_1D[0,[int(dst[[np.argsort(dst[:,0])[0]],3][0])]],\
                    lon_1D[0,[int(dst[[np.argsort(dst[:,0])[0]],4][0])]])
###
            #print(dst[[np.argsort(dst[:,0])[0]],0],lat_1D[[dst[[np.argsort(dst[:,0])[0]],3][0]],0],lon_1D[0,[dst[[np.argsort(dst[:,0])[0]],4][0]]])
###
            #print dst2[[np.argsort(dst2[:,0])[0]],0],\
                    #lat_1D2[[dst2[[np.argsort(dst2[:,0])[0]],3][0]],0],lon_1D2[0,[dst2[[np.argsort(dst2[:,0])[0]],4][0]]]
            ...
            #wg3_bis[np.invert(~np.isnan(wg3_ekf_bis))] = np.nan
            #wg3_ekf_bis[np.invert(~np.isnan(wg3_bis))] = np.nan
...
#R_mod.to_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/CustomPostProcessing/Data/conus_R_{0}/{1}_{2}_{3}_{4}_R.PData'.format(exp,ens_1,fc0,wg,dep))
#R_ekf.to_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/CustomPostProcessing/Data/conus_R_{0}/{1}_{2}_{3}_{4}_R.PData'.format(exp,ens_2,fc0,wg,dep))
#P_mod.to_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/CustomPostProcessing/Data/conus_R_{0}/{1}_{2}_{3}_{4}_P.PData'.format(exp,ens_1,fc0,wg,dep))
#P_ekf.to_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/CustomPostProcessing/Data/conus_R_{0}/{1}_{2}_{3}_{4}_P.PData'.format(exp,ens_2,fc0,wg,dep))
#E_mod.to_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/CustomPostProcessing/Data/conus_R_{0}/{1}_{2}_{3}_{4}_E.PData'.format(exp,ens_1,fc0,wg,dep))
#E_ekf.to_pickle('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/CustomPostProcessing/Data/conus_R_{0}/{1}_{2}_{3}_{4}_E.PData'.format(exp,ens_2,fc0,wg,dep))
