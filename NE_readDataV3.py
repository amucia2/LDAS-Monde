...
forcing_dir = r'C:\Users\antho\Documents\SXVGO1\CustomPostProcessing\Data\NE'
...
var_period = pd.read_pickle(r'C:\Users\antho\Documents\SXVGO1\CustomPostProcessing\Data\NE\NE_2009_RF.PData')
...
width = 0.35   
fig = plt.figure(figsize=(11,4),dpi=80,edgecolor='w')
#fig = plt.figure()
ax = fig.add_subplot(111)
ax2 = ax.twinx()
rects1 = ax.bar(x - width/2, gi_rain, width, label='ERA5',color='c')
rects2 = ax.bar(x + width/2, gi_2009, width, label='Station',color='b')

ax.set_title('Grand Island Precipitation : Station Obs vs ERA5 2009')
...
fig.legend(loc=(0.9,0.8),fontsize=8)
