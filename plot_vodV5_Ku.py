...
file = sorted(glob.glob('/cnrm/vegeo/muciaa/ldas_chain_python/ldas_curr/US00/observations/sfx-trip/VODKu*.PData'),key=numericalSort)
...
for d in tqdm(range(len(A))): 
    if d < 5844:
        ...
        try:
            ...
            # create file
            f= open('VODKu_2_LAI_cdf/CANARI/CANARI_NATURE_'+YY+MM+DD+'H09.DAT','a+')
            # write in file
...
import joblib
joblib.dump(A,'LAIfromVODCAKu_V7_2003-2018.PData')
'''        
