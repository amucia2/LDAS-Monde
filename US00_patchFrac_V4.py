...
axs[0,2].set_title('C3 Herbaceous')
axs[0,2].set_xlim(0,6.5)
axs[0,2].set_ylim(0,1.0)
xlims9=(0,6.5)
x9, y9, ext9, line9 = prep_reg(lai_cgls.loc[:,patch_9 >perc],vodx.loc[:,patch_9 >perc],xlims9)
axs[0,2].plot(ext9,line9,color='purple',linestyle='--')
axs[0,2].scatter(lai_cgls.loc[:,patch_9 >perc],vodx.loc[:,patch_9 >perc],c='black',s=2)
axs[0,2].scatter(lai_cgls_win.loc[:,patch_9 >perc].mean(axis=1),vodx_win.loc[:,patch_9 >perc].mean(axis=1),c='blue',s=4)
axs[0,2].scatter(lai_cgls_spr.loc[:,patch_9 >perc].mean(axis=1),vodx_spr.loc[:,patch_9 >perc].mean(axis=1),c='green',s=4)
axs[0,2].scatter(lai_cgls_sum.loc[:,patch_9 >perc].mean(axis=1),vodx_sum.loc[:,patch_9 >perc].mean(axis=1),c='red',s=4)
axs[0,2].scatter(lai_cgls_aut.loc[:,patch_9 >perc].mean(axis=1),vodx_aut.loc[:,patch_9 >perc].mean(axis=1),c='yellow',s=4)
axs[0,2].set_xlabel('LAI [m^2/m^-2]',color='green')
axs[0,2].set_ylabel('VODX',color='red')

axs[1,2].set_title('Irrigated Crops')
axs[1,2].set_xlim(0,6.5)
axs[1,2].set_ylim(0,1.0)
xlims10=(0,6.5)
x10, y10, ext10, line10 = prep_reg(lai_cgls.loc[:,patch_10 >perc],vodx.loc[:,patch_10 >perc],xlims10)
axs[1,2].plot(ext10,line10,color='purple',linestyle='--')
axs[1,2].scatter(lai_cgls.loc[:,patch_10 >perc],vodx.loc[:,patch_10 >perc],c='black',s=2)
axs[1,2].scatter(lai_cgls_win.loc[:,patch_10 >perc].mean(axis=1),vodx_win.loc[:,patch_10 >perc].mean(axis=1),c='blue',s=4)
axs[1,2].scatter(lai_cgls_spr.loc[:,patch_10 >perc].mean(axis=1),vodx_spr.loc[:,patch_10 >perc].mean(axis=1),c='green',s=4)
axs[1,2].scatter(lai_cgls_sum.loc[:,patch_10 >perc].mean(axis=1),vodx_sum.loc[:,patch_10 >perc].mean(axis=1),c='red',s=4)
axs[1,2].scatter(lai_cgls_aut.loc[:,patch_10 >perc].mean(axis=1),vodx_aut.loc[:,patch_10 >perc].mean(axis=1),c='yellow',s=4)
axs[1,2].set_xlabel('LAI [m^2/m^-2]',color='green')
axs[1,2].set_ylabel('VODX',color='red')
...
axs[0,2].plot(ext9,line9,color='purple',linestyle='--')
axs[0,2].scatter(lai_cgls.loc[:,patch_9 >perc],vodc.loc[:,patch_9 >perc],c='black',s=2)
axs[0,2].scatter(lai_cgls_win.loc[:,patch_9 >perc].mean(axis=1),vodc_win.loc[:,patch_9 >perc].mean(axis=1),c='blue',s=4)
axs[0,2].scatter(lai_cgls_spr.loc[:,patch_9 >perc].mean(axis=1),vodc_spr.loc[:,patch_9 >perc].mean(axis=1),c='green',s=4)
axs[0,2].scatter(lai_cgls_sum.loc[:,patch_9 >perc].mean(axis=1),vodc_sum.loc[:,patch_9 >perc].mean(axis=1),c='red',s=4)
axs[0,2].scatter(lai_cgls_aut.loc[:,patch_9 >perc].mean(axis=1),vodc_aut.loc[:,patch_9 >perc].mean(axis=1),c='yellow',s=4)
axs[0,2].set_xlabel('LAI [m^2/m^-2]',color='green')
axs[0,2].set_ylabel('VODC',color='red')
...
axs[1,2].plot(ext10,line10,color='purple',linestyle='--')
axs[1,2].scatter(lai_cgls.loc[:,patch_10 >perc],vodc.loc[:,patch_10 >perc],c='black',s=2)
axs[1,2].scatter(lai_cgls_win.loc[:,patch_10 >perc].mean(axis=1),vodc_win.loc[:,patch_10 >perc].mean(axis=1),c='blue',s=4)
axs[1,2].scatter(lai_cgls_spr.loc[:,patch_10 >perc].mean(axis=1),vodc_spr.loc[:,patch_10 >perc].mean(axis=1),c='green',s=4)
axs[1,2].scatter(lai_cgls_sum.loc[:,patch_10 >perc].mean(axis=1),vodc_sum.loc[:,patch_10 >perc].mean(axis=1),c='red',s=4)
axs[1,2].scatter(lai_cgls_aut.loc[:,patch_10 >perc].mean(axis=1),vodc_aut.loc[:,patch_10 >perc].mean(axis=1),c='yellow',s=4)
axs[1,2].set_xlabel('LAI [m^2/m^-2]',color='green')
axs[1,2].set_ylabel('VODC',color='red')
